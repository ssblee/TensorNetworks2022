function [SE,varargout] = SEtrick_Ex (ocont,Acont1,Acont2,varargin)
% < Description >
%
% SE = SEtrick_Ex (ocont,Acont1,Acont2) % self-energy only
% [SE,Aimp] = SEtrick_Ex (ocont,Acont1,Acont2,epsd,RhoV2in) % also obtain
...
if ~isempty(RhoV2in) % compute the improved estimate of the impurity spectral function
    ...
    varargout = {... % put the variable for the improved estimate here
        };
end
